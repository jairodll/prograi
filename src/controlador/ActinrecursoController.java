...
import static controlador.ActinorgController.idorganizacion;
import java.net.URL;
 ...
 */
public class ActinrecursoController implements Initializable {
    ...
    private void consulta(ActionEvent event) {
        idrecurso = txtcode.getText().trim();
        try {
            txtcode.setEditable(false);
            Connection cn = conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
            "select nombrerecurso, estado FROM recurso where idrecurso ='"+idrecurso +"'");
    ...
    private void modify(ActionEvent event) {
        try {
            Connection cn = conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
            "update recurso SET estado= ? where idrecurso ='"+idorganizacion +"'"); 
