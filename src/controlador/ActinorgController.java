 ...
 */
public class ActinorgController implements Initializable {
    ...
    private void consulta(ActionEvent event) {
        idorganizacion = txtcode.getText().trim();
        try {
            txtcode.setEditable(false);
            Connection cn = conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
            "select nombreorganizacion, estado FROM organizacion where idorganizacion ='"+idorganizacion +"'");
    ...
    private void modify(ActionEvent event) {
        try {
            Connection cn = conexion.conectar();
            PreparedStatement pst = cn.prepareStatement(
            "update organizacion SET estado= ? where idorganizacion ='"+idorganizacion +"'"); 
